...
|---        | ---   | ---           |  ---      |  ---      | ---           | --- |
|19/07/2024         | Unwanted space |<a href="/assets/images/screenshots/p1-identified.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p1-tested.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p1-tested.png" target="_blank">Screenshot</a>|There was unwanted space betweem the upper image and lower image for smaller screen size. This was tested using dev tools and then fixed on GitPod| 19/07/2024|
...
| 19/07/2024| Page not responsive due to nav |<a href="/assets/images/screenshots/p3-identified.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p3-tested.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p3-fixed.png" target="_blank">Screenshot</a>|Page was not responsive due to the navigation menu. The two columns would not move to the next line as designed using bootstrap. This was due to the set width which was identified using DevTools.  | 19/07/2024|
| 20/07/2024| Text overflows to the section above |<a href="/assets/images/screenshots/p4-identified.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p4-tested.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p4-fixed.png" target="_blank">Screenshot</a>|Text overflows from the textbox container and is hidden under the image for smaller devices. Problem has been identified and the fix was tested using DevTool. This was then implemented on GitPod  | 20/07/2024|
| 20/07/2024| Images and Text overlaps each other for small devices |<a href="/assets/images/screenshots/p5-identified.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p5-tested.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p5-fixed.png" target="_blank">Screenshot</a>|Text and images overlaps one another smaller devices. Problem has been identified and the fix was tested using DevTool. This was then implemented on GitPod  | 20/07/2024|
| 20/07/2024| Unwanted margin on the right side of the page |<a href="/assets/images/screenshots/p6-identified.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p6-tested.png" target="_blank">Screenshot</a>|<a href="/assets/images/screenshots/p6-fixed.png" target="_blank">Screenshot</a>|There was an unwated margin on the right side of the page which was caused by bootstrap. I had removed it for one of the row. Upon retesting, the problem was still there. Upon further checking using DevTools, I realised that I needed to apply this solution for all of the rows. Once completed, this was rechecked. It worked as expected.  | 20/07/2024|
