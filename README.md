...
* **Footer** - Footer was coded to be at the bottom of the page, however, the code was making it stick. I tried using other options such as making the body position relative and footer position absolute, however it did not give me the results I wanted. The footer was at the bottom of the body section, however, I wanted it to be at the bottom of the page even if there is no content. I used [DEV](https://dev.to/nehalahmadkhan/how-to-make-footer-stick-to-bottom-of-web-page-3i14) to help me sort this problem. 
